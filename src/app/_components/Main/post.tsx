...
import { Add, HorizontalRule, MoreVert } from "@mui/icons-material";
  ...
  return (
    <Box className="w-full h-full">
      <Box className="h-[400px] rounded-[32px] my-8 w-full bg-opacity-10 bg-gray-200/5 flex flex-col justify-center items-center">
        ...
        {/* Post Image */}
        <Box className="flex bg-gray-300/5 rounded-3xl items-center justify-center object-fit w-[470px] h-[234px] my-2">
